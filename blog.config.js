...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '你好, 我是何电控, 长期从事控制专业, 这里想分享一些小技术和心得体会!',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HELI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '何电控13402112429', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wecontrol.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'control, control, control', // 网站关键词 英文逗号隔开
